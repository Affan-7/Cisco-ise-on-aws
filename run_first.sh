...
# username 'admin' is a hardcoded value and should not be changed. Lastly the
...
# time zones https://www.cisco.com/c/en/us/td/docs/wireless/ncs/appliance/install/guide/primencs_qsg/primencs_qsgtimezones.html
